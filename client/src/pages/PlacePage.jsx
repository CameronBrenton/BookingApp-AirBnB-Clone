  ...
  return (
    <div className="px-8 py-8 mt-4 -mx-8 bg-gray-100">
	  ...
	  <div className="grid gap-2 grid-cols-[2fr_1fr]">
		...
		<div className="grid ">
		{place.photos?.[1] && (
				<img className='object-cover aspect-square' src={'http://localhost:4000/uploads/'+place.photos[1]} alt="" />
			)}
			<div className="overflow-hidden">
			{place.photos?.[2] && (
				<img className='relative object-cover aspect-square top-2' src={'http://localhost:4000/uploads/'+place.photos[2]} alt="" />
			)}
			</div>
		</div>
	  </div>
